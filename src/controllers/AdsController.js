...
module.exports = {
    getCategories: async (req, res) => {
        ...
        //...cats[i], clona o item geral com várias tags de lixo
        //...cats[i]._doc clona o item somente com os dados
    ...
    getList: async (req, res) => {
        let { sort = 'desc', offset = 0, limit = 8, q, cat, state } = req.query;
    ...
    editAction: async (req, res) => {
        ...
        //Código do exercício para novas imagens
        if(req.files && req.files.img) {
